                ...
                <div class="container mx-auto">
                    <div class="p-8">
                        <form action=" {{ url('kandidat') }} " method="POST" enctype="multipart/form-data">
                            ...
                            <div class="text-end mt-1">
                                <a
                                    class="bg-red-500 text-white py-2.5 px-4 rounded-full shadow-md hover:bg-red-600 text-sm font-semibold transition-all ease-in-out cursor-pointer mt-1"href="{{ route('kandidat.index') }}">Back</a>
                                <input
