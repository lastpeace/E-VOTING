                ...
                <div class="p-8">
                    <form action=" {{ url('kandidat') }} " method="POST" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <textarea class="rounded-[30px] w-full placeholder:italic" name="visi" id="visi" cols="30" rows="10" placeholder="Masukkan Visi"></textarea>
                        </div>
                        <div>
                            <label class="block font-medium text-md" for="misi">Misi</label>
                            <textarea class="rounded-[30px] w-full placeholder:italic" name="misi" id="misi" cols="30" rows="10" placeholder="Masukkan misi"></textarea>
                        </div>
                        @if ($errors->any())
