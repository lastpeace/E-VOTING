    ...
    <div class="mx-auto h-full bg-white rounded-t-[50px]">
        ...
        <div class="container mx-auto">
            <!--Container-->
                ...
                <a class="bg-red-600 text-white p-2.5 rounded-full shadow-md hover:bg-red-700 text-sm font-semibold transition-all ease-in-out" href="{{ route('kelas.index') }}">Kembali</a>
                <a class="bg-blue-600 text-white p-2.5 rounded-full shadow-md hover:bg-blue-700 text-sm font-semibold transition-all ease-in-out ml-3" href="{{ url('kelas/create') }}">Tambah Kelas</a>
            </div>
                    ...
                    <table id="example" class="stripe hover"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th data-priority="2">Nama Kelas</th>
                                ...
                                <td>
                                    <div class="container flex p-2 w-3/4 mx-auto">
                                        ...
                                        <div class="mx-auto p-2">
                                            <form class="m-auto" onsubmit="return confirm('Yakin akan menghapus data?')"action="{{ url('kelas/' . $item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
