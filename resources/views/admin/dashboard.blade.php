...
<div class="pt-2">
    ...
    <div class="mx-auto h-auto bg-white rounded-t-[50px]">
        ...
        <div class="container mx-auto px-6 py-5 sm:flex sm:gap-7 w-full">
            ...
            <div class="mx-auto rounded-lg shadow-lg my-5 bg-white">
                <p class="uppercase text-center text-2xl font-semibold pt-5">{{ $item->nama_kandidat }}
                </p>
                @if ($item->foto)
    ...
    <div class="mx-auto h-full bg-white rounded-t-[50px]">
        ...
        <div class="container mx-auto px-6 py-5 sm:flex sm:gap-7 w-full">
            <div
                class="mx-auto my-5 text-center font-bold uppercase text-5xl text-white bg-red-600 hover:bg-red-700 shadow-lg p-5 rounded-lg cursor-default">
                !! DATA KOSONG !!
            </div>
        </div>
    </div>
